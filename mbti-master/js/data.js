...
const qnaList = [
    ...
    {
      q: 'Q5. 오늘 연인과 첫 데이트 하는 날이다. 첫 날 허용할 수 있는 스킨십의 범위는?',
      a: [
    ...
    {
      q: 'Q6. 기념일이 다가온다. 당신은 어떻게 할 것인가? (ex - 100, 200일)',
      a: [
    ...
    {
      q: 'Q8. 연인이 데이트가 끝난 후, 집에 데려다 달라고 한다',
      a: [
    ...
    {
      q: 'Q10. 연인이 연락도 없이 보고싶다고 우리집 앞에 와서 기다린다. ',
      a: [
  ...
  const infoList = [
    {
      name: '연애 뭐 식은 죽 먹기죠, 연애 재능 만땅 파라오맛 쿠키',
    ...
    {
      name: '난 너만 봐, 정직한 연애 스타일의 클레오파트라맛 쿠키',
    ...
    {
      name: '이건 어때? 난 어때? 독특한 매력을 가진 홍길동맛 쿠키',
    ...
    {
      name: '결혼은 언제쯤 할까 신혼여행은 어디로?, 이상적인 연애관의 소유자 초코틴틴맛 쿠키',
    ...
    {
      name: '기념일에 무슨 이벤트 할까, 이벤트 플래너 김삿갓맛 쿠키',
    ...
    {
      name: '어 오늘 머리 바꿨네 잘 어울린다, 센스가 뛰어난 마카롱맛 쿠키',
    ...
    {
      name: '난 너랑 하는 것들 다 좋아, 순종적인 떡토끼맛 쿠키',
    ...
    {
      name: '난 당신의 연예인, 끼가 넘치는 재주꾼 블라썸맛 쿠키',
    ...
    {
      name: '이건 이거고 저건 저거지 , 공과사 확실한 얼음맛 쿠키',
    ...
    {
      name: '난 네가 좋아 너무 좋아, 애교만땅 할로윈박하사탕맛 쿠키',
    ...
    {
      name: '산은 산이요 연애는 연애로다, 느긋하고 온순한 초록돼지맛 쿠키',
